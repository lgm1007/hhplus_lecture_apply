...
class LectureOptionService(
	 ...
	 */
	fun getAllLecturesByApplicationDateAfter(nowDate: LocalDateTime): List<LectureOptionDto> {
		return lectureOptionRepository.findAllByApplicationDateAfter(nowDate).map {
